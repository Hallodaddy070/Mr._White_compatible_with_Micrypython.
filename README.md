...
After connecting your fx-CG50, paste the file (Mr.\_\White\_\(version).py) beside the other files (not inside any folder, you can paste it inside a folder in the Python app but this is the fastest way.). When you open Python you will see it there, click run to play.
